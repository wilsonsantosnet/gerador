...
public class PaginatedDataIQueryable<T> : List<T> where T : class
{
    ...
    public PaginatedDataIQueryable(IQueryable<T> source, Filter filter, int totalCount)
    {
        this.Paging(source, filter, totalCount);
    }
    public PaginatedDataIQueryable(IQueryable<T> source, Filter filter)
    {
    ...
    private void Paging(IQueryable<T> source, Filter filter, int totalCount)
    {
