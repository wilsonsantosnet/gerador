...
public class PaginatedDataIEnumerable<T> : List<T> where T : class
{
    ...
    public PaginatedDataIEnumerable(IEnumerable<T> source, Filter filter, int totalCount)
    {
        this.Paging(source, filter, totalCount);
    }
    public PaginatedDataIEnumerable(IEnumerable<T> source, Filter filter)
    {
    ...
    private void Paging(IEnumerable<T> source, Filter filter, int totalCount)
    {
